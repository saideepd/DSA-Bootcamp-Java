...
public class orderAgnosticBinarySearchAlgorithm {
    public static void main(String[] args) {
        System.out.println("Order Agnostic Binary Search Algorithm");

        int[] arr1 = {-10, -5, 1, 3, 7, 9, 12, 34};
        int[] arr2 = {28, 20, 16, 11, 9, 5, 2, 0, -3, -7};

        System.out.println(Arrays.toString(arr1) + ", 9 = " + orderAgnosticBinarySearch(arr1, 9));
        System.out.println(Arrays.toString(arr1) + ", 34 = " + orderAgnosticBinarySearch(arr1, 34));
        System.out.println(Arrays.toString(arr2) + ", -3 = " + orderAgnosticBinarySearch(arr2, -3));
        System.out.println(Arrays.toString(arr2) + ", 20 = " + orderAgnosticBinarySearch(arr2, 20));
    }
